...
public class DateActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int curMonth = calendar.get(Calendar.MONTH);
        DateNumericAdapter monAdapter = new DateNumericAdapter(this, 1, 12, curMonth);
...
//        year.addChangingListener(listener);
        DateNumericAdapter yearAdapter = new DateNumericAdapter(this, curYear - 10, curYear, curYear);
...
//        day.setCurrentItem(curDay - 1, true);
        DateNumericAdapter dayAdapter = new DateNumericAdapter(this, 1, maxDays, maxDays - 1);
